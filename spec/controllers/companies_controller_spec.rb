...
valid_attributes = {
  :siret => '11111111111111', :company_name => "company1"
  }
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested company" do
        ...
        Company.any_instance.should_receive(:update_attributes).with({"company_name" => 'company'})
        @company.company_name = 'company'
        put :update, {:id => @company.to_param, :company => {"company_name" => 'company'}}
      end
